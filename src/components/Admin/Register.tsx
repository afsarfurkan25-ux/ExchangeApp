...
const Register: React.FC = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Hash the password before storing - we never store plaintext
        ...
        <div style={{
            ...
            <div style={{
                ...
                <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    {/* Terms */}
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', textAlign: 'left', marginTop: '4px' }}>
                        <input
                            type="checkbox"
                        ...
                        />
                        <label htmlFor="termsCheckbox" style={{ color: '#8B97B8', fontSize: '13px', lineHeight: 1.5, cursor: 'pointer' }}>
